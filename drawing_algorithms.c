...
void draw_line_with_midpoint_algorithm(int x1, int y1, int x2, int y2, int color) {
    ...
    if (absdx >= absdy) {
        ...
        if (dx >= 0) {
            ...
            if (dy >= 0) {
                // Octante 4 (troca p1 com p2)
                draw_line_octant_4(x2, y2, x1, y1, color);
            } else {
                // Octante 5 (troca p1 com p2)
                draw_line_octant_5(x2, y2, x1, y1, color);
            }
        }
    } else {
        // Inclinação > 45 graus
        if (dy >= 0) {
            ...
            if (dx >= 0) {
                // Octante 7 (troca p1 com p2)
                draw_line_octant_7(x2, y2, x1, y1, color);
            } else {
                // Octante 6 (troca p1 com p2)
                draw_line_octant_6(x2, y2, x1, y1, color);
            }
        }
    }
}